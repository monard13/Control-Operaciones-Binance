...
const extractDataFromImage = async (base64Image: string, mimeType: string, prompt: string): Promise<ExtractedInfo[]> => {
    ...
    try {
        ...
        console.error("Failed to parse JSON from API response:", response.text);
    ...
    const handleProcessFiles = async () => {
        ...
        try {
            ...
            for (const file of files) {
                ...
                const extracted = await extractDataFromImage(base64String, file.type, geminiPrompt);
            ...
            setTimeout(() => setSuccessMessage(null), 4000);
             ...
             if (e instanceof Error && e.message === "Could not parse extracted data.") {
