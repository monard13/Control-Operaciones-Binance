// FIX: Import Request and Response types from express to ensure correct type resolution.
...
// GET all orders
// FIX: Use imported Request and Response types for route handlers to avoid type conflicts.
